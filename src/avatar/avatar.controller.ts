...
export class AvatarController {
  ...
  @Post('confirm')
  @ApiOperation({ summary: 'Xác nhận upload hoàn tất và bắt đầu tối ưu avatar' })
  @ApiResponse({ status: 200, description: 'Xác nhận thành công, avatar đang được tối ưu' })
  async confirm(@Body() dto: ConfirmUploadDto, @Req() req: any) {
    const userId = req.user.sub;
